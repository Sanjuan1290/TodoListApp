    ...
    return(
        <form className="flex flex-col absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 text-center gap-5">
            ...
            <div className="flex flex-col">
                <input type="text" name="text" placeholder="Email address"  className="rounded-t-md bg-transparent border border-gray-400 text-[14px] px-2 py-1 text-white w-[450px] placeholder:text-gray-500"/>
                <input type="passwrod" name="passwrod" placeholder="Password"  className="rounded-b-md mt-[-1px] bg-transparent border border-gray-400 text-[14px] px-2 py-1 text-white w-[450px] placeholder:text-gray-500"/>
            </div>
